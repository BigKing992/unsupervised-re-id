...
from pu import datasets
from pu import models
from pu.models.memory import MemoryBank
from pu.trainers import Trainer
from pu.evaluators import Evaluator, extract_features
from pu.utils.data import IterLoader
from pu.utils.data import transforms as T
from pu.utils.data.sampler import GroupSampler
from pu.utils.data.preprocessor import Preprocessor
from pu.utils.logging import Logger
from pu.utils.serialization import load_checkpoint, save_checkpoint, copy_state_dict
from pu.utils.faiss_rerank import compute_jaccard_distance, pairwise_distance
...
def main_worker(args):
    ...
    # optimizer = torch.optim.LBFGS(params, lr=args.lr, max_iter=20, max_eval=None, tolerance_grad=1e-07, tolerance_change=1e-09, history_size=100, line_search_fn=None)
    # lr_scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer, mode='min', factor=0.1, patience=5, verbose=True, eps=1e-8)
    ...
    for epoch in range(args.epochs):
        ...
        features = memory.features.clone()#克隆特征
        #计算Jaccard距离
